  ...
  <div class="login-container">
    <div class="login-box">
      <div class="login-image">
        <img
          src="https://www.kucni-ljubimci.com/wp-content/uploads/2017/02/Kucni-ljubimci-facebook-share.jpg"
          alt="Login Slika"
        />
      </div>
...
.login-container {
  ...
  height: 100vh;
  background: url('https://as1.ftcdn.net/v2/jpg/01/07/54/74/1000_F_107547435_vseggy1QpSh5YvCXIZTk0rOv3JO8XmCJ.jpg')
